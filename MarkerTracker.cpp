...
void MarkerTracker::findMarker( cv::Mat &img_bgr, float resultMatrix[16] )
{
...

	{
		...
		// Threshold of pixel getting assigned either black or white (pixel value < threshold => black, otherwise white)
		...
		for (; contours; contours = contours->h_next)
		{
			...
			// draw the polygon (1 -> 1 contour, we have a closed contour)
